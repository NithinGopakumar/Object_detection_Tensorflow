...
class KangarooDataset(utils.Dataset):
    ...
    def load_Kangaroo(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "via_prjct.json")))
...
def train(model):
    ...
    dataset_train.load_Kangaroo(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = KangarooDataset()
    dataset_val.load_Kangaroo(args.dataset, "valid")
    dataset_val.prepare()
